...
- `添加剧情元素`[激活剧情](./act-element.html#激活剧情)
- `拖动箭头">"，连接到后置剧目左边的箭头">"`
- 只有当后置剧目被[激活剧情](./act-element.html#激活剧情)激活后它才能被触发

### 分叉流程
- 通过[选项](./act-element.html#选项)实现剧情分叉

### 环形流程

- 单剧目环：其内的[激活剧情](./act-element.html#激活剧情)激活自身的剧目。该剧目可以被反复触发。
