...
- 在条件前加上字符"!"，表示否定，只有在该条件没有被激活时才能触发该剧目
...
- 剧目触发时, 有相应的概率被满足（例如--50%--为条件有50%的概率满足）。
- 概率条件不使用"[激活条件](./act-element.html#激活条件)"和"[移除条件](./act-element.html#激活条件)"激活和移除。
